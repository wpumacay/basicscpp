...
class Maze 
{
    ...
    // Returns the index in memory for the given location
    int getArrayIndex( const Location &loc ) const;
    
    // Returns the location in extended coordinates of the given cell
    Location getCellArrayCoord( int cellRow, int cellCol ) const;

    // Return the location of the wall at given cell and given direction
